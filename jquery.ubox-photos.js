(function($){
    ...
    $.ubox_photos.options =
    {
template: "<div id='ubox-photo' class='loading' style='display: none'><a class='ubox-close' rel='ubox-close'>Close</a><div class='spinner'>Loading...</div><div class='photo'><img class='_photo' /></div></div>",
        delay: 0
    };
